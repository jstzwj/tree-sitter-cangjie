...
enum ts_symbol_identifiers {
  ...
  anon_sym_DOLLAR = 11,
  sym_line_comment = 12,
  sym_delimited_comment = 13,
  sym_source_file = 14,
  sym__end = 15,
  sym_preamble = 16,
  sym_package_header = 17,
  sym_package_name_identifier = 18,
  sym_import_list = 19,
  sym_import_part = 20,
  sym_comment = 21,
  aux_sym_preamble_repeat1 = 22,
  aux_sym_package_name_identifier_repeat1 = 23,
  aux_sym_import_list_repeat1 = 24,
  aux_sym_import_part_repeat1 = 25,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [sym_package_name_identifier] = "package_name_identifier",
  [sym_import_list] = "import_list",
  [sym_import_part] = "import_part",
  [sym_comment] = "comment",
  [aux_sym_preamble_repeat1] = "preamble_repeat1",
  [aux_sym_package_name_identifier_repeat1] = "package_name_identifier_repeat1",
  [aux_sym_import_list_repeat1] = "import_list_repeat1",
  [aux_sym_import_part_repeat1] = "import_part_repeat1",
};
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_package_name_identifier] = sym_package_name_identifier,
  [sym_import_list] = sym_import_list,
  [sym_import_part] = sym_import_part,
  [sym_comment] = sym_comment,
  [aux_sym_preamble_repeat1] = aux_sym_preamble_repeat1,
  [aux_sym_package_name_identifier_repeat1] = aux_sym_package_name_identifier_repeat1,
  [aux_sym_import_list_repeat1] = aux_sym_import_list_repeat1,
  [aux_sym_import_part_repeat1] = aux_sym_import_part_repeat1,
};
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [aux_sym_package_name_identifier_repeat1] = {
    .visible = false,
    .named = false,
  },
...
static TSCharacterRange sym_identifier_character_set_4[] = {
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_character_set_2, 668, lookahead)) ADVANCE(16);
      END_STATE();
    case 1:
      ADVANCE_MAP(
        '\n', 14,
    ...
    case 6:
      ...
      if (set_contains(sym_identifier_character_set_4, 775, lookahead)) ADVANCE(6);
      END_STATE();
    case 7:
      if (set_contains(sym_identifier_character_set_2, 668, lookahead)) ADVANCE(6);
      END_STATE();
    case 8:
      if (eof) ADVANCE(9);
      ADVANCE_MAP(
    ...
    case 16:
      ACCEPT_TOKEN(sym_identifier);
      if (set_contains(sym_identifier_character_set_3, 776, lookahead)) ADVANCE(16);
      END_STATE();
    case 17:
    ...
    case 18:
      ...
      END_STATE();
    case 19:
      ACCEPT_TOKEN(sym_delimited_comment);
      END_STATE();
    default:
      return false;
  }
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [sym_delimited_comment] = ACTIONS(5),
  },
  [1] = {
    [sym_source_file] = STATE(73),
    [sym_preamble] = STATE(76),
    [sym_package_header] = STATE(11),
    [sym_import_list] = STATE(36),
    [sym_comment] = STATE(1),
    ...
    [sym_delimited_comment] = ACTIONS(9),
  },
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [19] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_preamble, 2, 0, 0),
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_preamble, 1, 0, 0),
  [23] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_preamble_repeat1, 2, 0, 0),
  [25] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_preamble_repeat1, 2, 0, 0), SHIFT_REPEAT(66),
  [28] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_preamble_repeat1, 2, 0, 0), SHIFT_REPEAT(27),
  [31] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_preamble_repeat1, 2, 0, 0), SHIFT_REPEAT(75),
  [34] = {.entry = {.count = 1, .reusable = false}}, SHIFT(30),
  [36] = {.entry = {.count = 1, .reusable = false}}, SHIFT(37),
  [38] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [40] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_import_part_repeat1, 2, 0, 0),
  [42] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_import_part_repeat1, 2, 0, 0), SHIFT_REPEAT(46),
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_import_part_repeat1, 2, 0, 0), SHIFT_REPEAT(71),
  [48] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__end, 1, 0, 0),
  [50] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__end, 1, 0, 0),
  [52] = {.entry = {.count = 1, .reusable = false}}, SHIFT(40),
  [54] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import_part, 1, 0, 0),
  [56] = {.entry = {.count = 1, .reusable = false}}, SHIFT(46),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_part, 1, 0, 0),
  [60] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import_part, 2, 0, 0),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_part, 2, 0, 0),
  [64] = {.entry = {.count = 1, .reusable = false}}, SHIFT(17),
  [66] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_import_part_repeat1, 2, 0, 0),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_list, 9, 0, 0),
  [72] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import_list, 9, 0, 0),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_list, 8, 0, 0),
  [76] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import_list, 8, 0, 0),
  [78] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [80] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_list, 7, 0, 0),
  [84] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import_list, 7, 0, 0),
  [86] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_package_name_identifier, 2, 0, 0),
  [88] = {.entry = {.count = 1, .reusable = false}}, SHIFT(64),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_package_name_identifier, 2, 0, 0),
  [92] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_import_part_repeat1, 4, 0, 0),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_import_part_repeat1, 4, 0, 0),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_list, 6, 0, 0),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import_list, 6, 0, 0),
  [100] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_import_part_repeat1, 3, 0, 0),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_import_part_repeat1, 3, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_list, 5, 0, 0),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import_list, 5, 0, 0),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_preamble_repeat1, 1, 0, 0),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_preamble_repeat1, 1, 0, 0),
  [114] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_list, 3, 0, 0),
  [118] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import_list, 3, 0, 0),
  [120] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_import_list_repeat1, 2, 0, 0),
  [122] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_import_list_repeat1, 2, 0, 0), SHIFT_REPEAT(37),
  [125] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_import_list_repeat1, 2, 0, 0), SHIFT_REPEAT(72),
  [128] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_package_name_identifier, 1, 0, 0),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_package_name_identifier, 1, 0, 0),
  [134] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_list, 4, 0, 0),
  [136] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import_list, 4, 0, 0),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_package_name_identifier_repeat1, 2, 0, 0),
  [140] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_package_name_identifier_repeat1, 2, 0, 0), SHIFT_REPEAT(64),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_package_name_identifier_repeat1, 2, 0, 0),
  ...
  [157] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_import_list_repeat1, 4, 0, 0),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_import_list_repeat1, 4, 0, 0),
  ...
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_import_list_repeat1, 2, 0, 0),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_package_header, 4, 0, 0),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_package_header, 4, 0, 0),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_package_name_identifier_repeat1, 3, 0, 0),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_package_name_identifier_repeat1, 3, 0, 0),
  [177] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_import_list_repeat1, 3, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_import_list_repeat1, 3, 0, 0),
  [181] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_package_header, 3, 0, 0),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_package_header, 3, 0, 0),
  ...
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 1, 0, 0),
};
