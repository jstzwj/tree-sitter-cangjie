...
enum ts_symbol_identifiers {
  ...
  anon_sym_DOLLAR = 12,
  sym_line_comment = 13,
  sym_delimited_comment = 14,
  anon_sym_DQUOTE = 15,
  anon_sym_DQUOTE_DQUOTE_DQUOTE = 16,
  sym_source_file = 17,
  sym__end = 18,
  sym_preamble = 19,
  sym_package_header = 20,
  sym_package_name_identifier = 21,
  sym_import_list = 22,
  sym_import_part = 23,
  sym_comment = 24,
  aux_sym_preamble_repeat1 = 25,
  aux_sym_package_name_identifier_repeat1 = 26,
  aux_sym_import_list_repeat1 = 27,
  aux_sym_import_part_repeat1 = 28,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 7:
      ...
      if (set_contains(sym_identifier_character_set_4, 775, lookahead)) ADVANCE(7);
      END_STATE();
    case 8:
      if (set_contains(sym_identifier_character_set_2, 668, lookahead)) ADVANCE(7);
      END_STATE();
    case 9:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [13] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import_part, 1, 0, 0),
  ...
  [25] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_import_part_repeat1, 2, 0, 0),
  [27] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_import_part_repeat1, 2, 0, 0), SHIFT_REPEAT(32),
  [30] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_import_part, 2, 0, 0),
  [32] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_preamble, 1, 0, 0),
  [34] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_import_list_repeat1, 2, 0, 0),
  [36] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_import_list_repeat1, 2, 0, 0), SHIFT_REPEAT(25),
  [39] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_package_name_identifier_repeat1, 2, 0, 0),
  [41] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_package_name_identifier_repeat1, 2, 0, 0), SHIFT_REPEAT(37),
  [44] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_package_name_identifier, 1, 0, 0),
  [46] = {.entry = {.count = 1, .reusable = false}}, SHIFT(37),
  [48] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_package_name_identifier, 2, 0, 0),
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_preamble_repeat1, 2, 0, 0),
  [52] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_preamble_repeat1, 2, 0, 0), SHIFT_REPEAT(36),
  [55] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_preamble_repeat1, 2, 0, 0), SHIFT_REPEAT(28),
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_preamble, 2, 0, 0),
  [60] = {.entry = {.count = 1, .reusable = false}}, SHIFT(30),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_list, 5, 0, 0),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__end, 1, 0, 0),
  [66] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_list, 6, 0, 0),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_list, 3, 0, 0),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_preamble_repeat1, 1, 0, 0),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_list, 4, 0, 0),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_package_header, 3, 0, 0),
