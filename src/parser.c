  ...
  switch (state) {
    case 0:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(0);
      if (set_contains(sym_identifier_character_set_1, 668, lookahead)) ADVANCE(15);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(10);
    ...
    case 9:
      ACCEPT_TOKEN(anon_sym_hello);
      if (set_contains(sym_identifier_character_set_2, 776, lookahead)) ADVANCE(15);
      END_STATE();
    case 10:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [5] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_NL, 1, 0, 0),
